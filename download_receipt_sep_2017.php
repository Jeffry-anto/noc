...
<body>
		<?php if(isset($_GET['app'])) 
		{
			...
			mysqli_select_db($conn,'NOCPayment');
...
/*				$amtsql = mysqli_query("SELECT paymentamount FROM NOCPayment.noctransaction_table where ApplicationNumber = '$appnum'");
		...
		<button type="submit" class="btn btn-success"  name="print" id="print" class="btn btn-success" style="float:right">PRINT</button>
		<form method="post"  action="pdfreceipt.php">
			<input type="submit" class="btn btn-success" style="float:right" value="PDF">
			...
			<div class="list-groupp" styele="margin-top:10px;">
			  <!-- <div class="list-group-itemm"><b>Name : </b><?php echo $name;?></div><br>
				...
				<div class="receiptcontent">
					...
					<input type="hidden" name="appno" value="<?php echo $appnum; ?> ">
					<input type="hidden" name="text" value="National Programme on Technology Enhanced Learning (NPTEL)" >
					...
					<input type="hidden" name="text1" value="Receipt for successful payment of fees for online courses conducted by NPTEL">
					<div>&nbsp;&nbsp;Name of candidate :  <b><?php echo $name;?></b></div><br>
					<input type="hidden" name="name" value="Name of candidate : <?php echo $name;?>"><br>
					<div>&nbsp;&nbsp;No.of courses taken :  <b>2</b></div><br>
					<input type="hidden" name="text2" value="No.of courses taken :<?php echo 2;  ?>"><br>
					<div>&nbsp;&nbsp;Courses name : <b><?php echo $course1," & ".$course2;?></b></div><br>
					<input type="hidden" name="text3" value="Courses name :<?php echo $course1," & ".$course2;?>"><br>
					<div>&nbsp;&nbsp;Date of exam : <b><?php echo $dt1," & ".$dt2;?></b></div><br>
					<input type="hidden" name="text4" value="Date of exam :<?php echo $dt1," & ".$dt2;?>"><br>
					<div>&nbsp;&nbsp;City of exam : <b><?php if($city1 == $city2) echo $city1; else echo $city1," & ".$city2;?></b></div><br>
					<input type="hidden" name="text5" value="City of exam :<?php if($city1 == $city2) echo $city1; else echo $city1," & ".$city2;?><br><br>">
					<div>&nbsp;&nbsp;Date of payment : <b><?php echo $day."-".$mnt."-".$yr;?></b></div><br>
					<input type="hidden" name="text6" value="Date of payment : <?php echo $day."-".$mnt."-".$yr;?>"><br>
					<div>&nbsp;&nbsp;Amount paid : <b>Rs.<?php echo $amount;?></b></div><br><br><br>
                    <input type="hidden" name="text7" value="Amount paid :<?php echo $amount;?>"><br>
					...
					<input type="hidden" name="text8" value="<i>We hereby acknowledge with thanks, the receipt of Rs.<?php echo $amount;?> from the afore-mentioned candidate towards payment for NPTEL Online Certification Exam, details of which are shown above.">
				</div>
			  	<?php } else { ?>
				<div class="receiptcontent">
				<h4><center><b>National Programme on Technology Enhanced Learning (NPTEL)</b></center></h4><br>
					...
					<center><b>Receipt for successful payment of fees for online courses conducted by NPTEL<br>Course Run: <?php echo $timeline;?></b></center><br><br>
					<div>&nbsp;&nbsp;Name of candidate :  <b><?php echo $name;?></b></div><br>
					<input type="hidden" name="name" value="Name of candidate : <?php echo $name;?><br><br>"><br>
					<div>&nbsp;&nbsp;Course name : <b><?php echo $course1;?></b></div><br>
					<input type="hidden" name="text3" value="Courses name :<?php echo $course1;?><br><br>"><br>
					<div>&nbsp;&nbsp;Date of exam : <b><?php echo $dt1;?></b></div><br>
					<input type="hidden" name="text4" value="Date of exam :<?php echo $dt1;?><br><br>"><br>
					<div>&nbsp;&nbsp;City of exam : <b><?php echo $city1;?></b></div><br>
					<input type="hidden" name="text5" value="City of exam :<?php echo $city1;?><br><br>">
					<div>&nbsp;&nbsp;Date of payment : <b><?php echo $day."-".$mnt."-".$yr;?></b></div><br>
					<input type="hidden" name="text6" value="Date of payment : <?php echo $day."-".$mnt."-".$yr;?><br><br>"><br>
					<div>&nbsp;&nbsp;Amount paid : <b>Rs.<?php echo $amount;?></b></div><br><br><br>
                    <input type="hidden" name="text7" value="Amount paid :<?php echo $amount;?>"><br>
					<i>We hereby acknowledge with thanks, the receipt of <b>Rs.<?php echo $amount;?></b> from the afore-mentioned candidate towards payment for NPTEL Online Certification Exam, details of which are shown above.</i><br></br>
					<input type="hidden" name="text8" value="<i>We hereby acknowledge with thanks, the receipt of Rs.<?php echo $amount;?> from the afore-mentioned candidate towards payment for NPTEL Online Certification Exam, details of which are shown above.">
