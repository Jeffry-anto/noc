<?php
session_start();
require('Connections/local_conn.php');
?>
<?php
...
if($_GET['id'] != '')
{
	...
	while($fetch_getquery = mysqli_fetch_array($get_query))
	{
        ...
        $NOCFinalScoreGraph = $fetch_getquery['NOCFinalScoreGraph'];
        ...
        $scorelogic=$fetch_getquery['NOCAssignmentLogicRemarks'];
        $legendlogic=$fetch_getquery['NOClegendlogic'];
...
$exmdate3 = '';
	...
	while($fetch_erc=mysqli_fetch_array($erc))
	{
            ...
            $gold=$fetch_erc['Gold'];
            $elite=$fetch_erc['Elite'];
            $succ=$fetch_erc['Successfully_completed'];
            $part=$fetch_erc['Participation'];
					}
...
<!--Certificate Category Count Start-->


<div class="container">
<div class="row">
<h4><b><u>Certified Category Count</u></b></h4>
<div class="col-sm-3">
<div class="panel panel-default">
   <div class="panel-heading">
      <h4 class=" panel-title text-center" style="font-weight:bold;">Gold</h4>
   </div>
   <div class="panel-body">
     <p style="text-align:center;"><?php if($gold != ''){ echo $gold; }else{ echo 'Will be announced';} ?></p>
   </div>
</div>
</div><!--end of col-sm-3-->
...
<div class="panel panel-default">
   <div class="panel-heading">
      <h4 class=" panel-title text-center" style="font-weight:bold;">Elite</h4>
   </div>
   <div class="panel-body">
     <p style="text-align:center;"><?php if($elite != ''){ echo $elite; }else{ echo 'Will be announced';} ?></p>
   </div>
</div>
</div><!--end of col-sm-3-->
...
<div class="panel panel-default">
   <div class="panel-heading">
      <h4 class=" panel-title text-center" style="font-weight:bold;">Successfully completed</h4>
   </div>
   <div class="panel-body">
     <p style="text-align:center;"><?php if($succ != ''){ echo $succ; }else{ echo 'Will be announced';} ?></p>
   </div>
</div>
</div><!--end of col-sm-3-->
...
<div class="panel panel-default">
   <div class="panel-heading">
      <h4 class=" panel-title text-center" style="font-weight:bold;">Participation</h4>
   </div>
   <div class="panel-body">
     <p style="text-align:center;"><?php if($part != ''){ echo $part; }else{ echo 'Will be announced';} ?></p>
   </div>
</div>
</div><!--end of col-sm-3-->
...
<!--Certificate Category Count End-->
...
{
	$Part = 'Certificateimages/'.$courseid1.'(P).jpg';
    $Success = 'Certificateimages/'.$courseid1.'(S).jpg';
    $Elite = 'Certificateimages/'.$courseid1.'(E).jpg';
    $Gold = 'Certificateimages/'.$courseid1.'(G).jpg';
	
if((file_exists($Part))|| (file_exists($Success)) || (file_exists($Elite))|| (file_exists($Gold)) )
{
?>
<div class="container">
<div class="row">
...
<div class="col-xs-3" id="part">
    <h2 style="font-size:21px; text-align:center; text-decoration:underline;"><b>Participation</b></h2>
<a href="#" data-toggle="modal" data-target="#partModal" data-backdrop="false">    
<img src="Certificateimages/<?php echo $courseid1.'(P).jpg'; ?>" width="250px" height="150px" ></a>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Participation Certificate</b></h4>
      </div>
      <div class="modal-body">
        <img src="<?php echo 'Certificateimages/'.$courseid1.'(P).jpg'; ?>" width="520px" height="480px">
      </div>
...
<div class="col-xs-3" id="success">
    <h2 style="font-size:21px; text-align:center; text-decoration:underline;"><b>Success</b></h2>
<a href="#" data-toggle="modal" data-target="#successModal" data-backdrop="false">    
<img src="<?php echo $Success; ?>" width="250px" height="150px" ></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Category : Successfully Completed</b></h4>
      </div>
      <div class="modal-body">
        <img src="<?php echo $Success; ?>" width="520px" height="450px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<div class="col-xs-3" id="elite">
    <h2 style="font-size:21px; text-align:center; text-decoration:underline;"><b>Elite</b></h2>
<a href="#" data-toggle="modal" data-target="#eliteModal" data-backdrop="false">    
<img src="<?php echo $Elite; ?>" width="250px" height="150px" ></a>
    
    <div id="eliteModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Category : Elite</b></h4>
      </div>
      <div class="modal-body">
        <img src="<?php echo $Elite; ?>" width="520px" height="480px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<div class="col-xs-3" id="gold">
    <h2 style="font-size:21px; text-align:center; text-decoration:underline;"><b>Gold</b></h2>
<a href="#" data-toggle="modal" data-target="#goldModal" data-backdrop="false">    
<img src="<?php echo $Gold; ?>" width="250px" height="150px" ></a>
    
    <div id="goldModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Category : Gold</b></h4>
      </div>
      <div class="modal-body">
        <img src="<?php echo $Gold; ?>" width="520px" height="480px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<?php
$legendlogic=mysqli_query($dbconn,"select * from noc_course where NOCCourseId= '".$_SESSION['courseid']."' ");
    while($llogic=mysqli_fetch_array($legendlogic))
    {
       $llogic = $llogic['NOClegendlogic'];
        echo  "$llogic";
    }
?>
...
<div class="col-xs-8">
<div class="well">
<h4 style=" font-weight:bold; text-decoration:underline;">Final Score Calculation Logic</h4>
<?php
$scorelogic=mysqli_query($dbconn,"select * from noc_course where NOCCourseId= '".$_SESSION['courseid']."' ");
    while($logic=mysqli_fetch_array($scorelogic))
    {
       $logic = $logic['NOCAssignmentLogicRemarks'];
        echo  "$logic";
    }
?>
...
if($coursestatus == 'comp')
{
    ...
    $Fgraph = 'graph/'.$courseid1.'(F).jpg';
if((file_exists($Agraph) ) || (file_exists($Egraph)) || (file_exists($Fgraph)))
{
?>
<div class="">
<div class="row">
...
<div class="well">
	...
	?>
<div class="col-xs-4" id="agraph">
    <h2 style="font-size:21px; text-align:center; text-decoration:underline;"><b>Assignment Score distribution</b></h2>
<a href="#" data-toggle="modal" data-target="#assignmentModal" data-backdrop="false">
<img src="<?php echo 'graph/'.$courseid1.'(A).jpg'; ?>" width="300px" height="200px"></a>
<div id="assignmentModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Assignment Score Distribution</b></h4>
      </div>
      <div class="modal-body">
        <img src="<?php echo 'graph/'.$courseid1.'(A).jpg'; ?>" width="550px" height="500px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<div class="col-xs-4" id="egraph">
    <h2 style="font-size:21px; text-align:center; text-decoration:underline;"><b>Exam Score distribution</b></h2>
<a href="#" data-toggle="modal" data-target="#examModal" data-backdrop="false">
<img src="<?php echo 'graph/'.$courseid1.'(E).jpg'; ?>" width="300px" height="200px"></a>
<div id="examModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Exam Score Distribution</b></h4>
      </div>
      <div class="modal-body">
        <img src="<?php echo 'graph/'.$courseid1.'(E).jpg'; ?>" width="550px" height="500px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
    ...
    <?php
if (file_exists($Fgraph)) {

	?>


<div class="col-xs-4" id="fgraph">
    <h2 style="font-size:21px; text-align:center; text-decoration:underline;"><b>Final Score distribution</b></h2>
<a href="#" data-toggle="modal" data-target="#finalModal" data-backdrop="false">
<img src="graph/<?php echo $courseid1.'(F).jpg'; ?>" width="300px" height="200px" ></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Final Score Distribution</b></h4>
      </div>
      <div class="modal-body">
        <img src="<?php echo 'graph/'.$courseid1.'(F).jpg'; ?>" width="550px" height="500px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<div style="clear:both;">
    ...
    <hr>
	<div><h4><b><u>Score Distribution Graph - Legend</u></b></h4></div>
    <h5><b>Assignment Score: Distribution of average scores garnered by students per assignment.</b></h5>
    <h5><b>Exam Score : Distribution of the final exam score of students.</b></h5>
    <h5><b>Final Score : Distribution of the combined score of assignments and final exam, based on the score logic.</b></h5>
						...
						<div class="panel-heading text-center"><b><?php echo $fetch_nocperiod['NOCCourseName']; ?> - Toppers list</b></div>
				  		<div class="panel-body">
							<?php
								...
								if($examperiod == 'Sep 2016' || $examperiod == 'Oct 2016' || $examperiod == 'Mar 2017' || $examperiod == 'Apr 2017' )
								{
									$gettotalQuery = mysqli_query($dbconn,"select FinalScore from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' and FinalScore >= 40");
									$certified_candidates = mysqli_num_rows($gettotalQuery);
									if($certified_candidates <= 10)
									{
										$topperMarksArray = array();
										$getCandidates = mysqli_query($dbconn,"select FinalScore from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' order by FinalScore DESC limit 1");
										...
										if(count($topperMarksArray) >0)
										{
											...
											$topperQuery = mysqli_query($dbconn,"select * from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' and b.FinalScore IN ($listnew) order by b.FinalScore desc");
											...
											{ ?>
												<div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
													<img src="./Candidate_photopath/<?php echo $month."-".$examperiod."/".$fetch_toppers2['photopath'];?>" alt="<?php echo $fetch_toppers2['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
													<div class="caption text-center">
										...
										$topperMarksArray = array();
										$getCandidates = mysqli_query($dbconn,"select FinalScore from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' order by FinalScore DESC limit 2");
										while($topperMarks = mysqli_fetch_assoc($getCandidates))
										{
											if($topperMarks['FinalScore'] >= 60)
											{
										...
										if(count($topperMarksArray) >0)
										{
											...
											{ ?>
												<div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
													<img src="./Candidate_photopath/<?php echo $month."-".$examperiod."/".$fetch_toppers2['photopath'];?>" alt="<?php echo $fetch_toppers2['Name']; ?>" alt="<?php echo $fetch_toppers2['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
													<div class="caption text-center">
														<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['Name']; ?> <span class="badge"><?php echo $fetch_toppers2['FinalScore'].'%'; ?></span></b></p>
														<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['CollegeName']; ?></b></p>
													    <p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['OrganizationName']; ?></b> </p>
									...
									{
										$topperMarksArray = array();
										$getCandidates = mysqli_query($dbconn,"select FinalScore from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' order by FinalScore DESC limit 5");
										while($topperMarks = mysqli_fetch_assoc($getCandidates))
										{
											if($topperMarks['FinalScore'] >= 60)
											{
									...
									} else if($certified_candidates > 100)
									{
										...
										$topperMarksArray = array();
										$getCandidates = mysqli_query($dbconn,"select FinalScore from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' order by FinalScore DESC limit $onepercent");
										while($topperMarks = mysqli_fetch_assoc($getCandidates))
										{
											if($topperMarks['FinalScore'] >= 60)
											{
										...
										if(count($topperMarksArray) > 0)
										{
											echo "<div class='col-md-12 alert alert-success' style='text-align:center;font-weight:bold;font-size: 17px;'>Top 1 % of Certified Candidates</div>";
											$listnew = "'". implode("', '", $topperMarksArray) ."'";
											$topperQuery = mysqli_query($dbconn,"select * from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' and b.FinalScore IN ($listnew) order by b.FinalScore desc");
											while($fetch_toppers2 = mysqli_fetch_array($topperQuery))
											{
										...
										$topperMarksArray = array();
										$getCandidates = mysqli_query($dbconn,"select FinalScore from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' order by FinalScore DESC limit $twopercent");
										while($topperMarks = mysqli_fetch_assoc($getCandidates))
										{
											if($topperMarks['FinalScore'] >= 60)
											{
										...
										if(count($topperMarksArray) > 0)
										{
											echo "<br><div class='col-md-12 alert alert-success' style='text-align:center;font-weight:bold;font-size: 17px;'>Top 2 % of Certified Candidates</div>";
											$listnew = "'". implode("', '", $topperMarksArray) ."'";
											$topperQuery = mysqli_query($dbconn,"select * from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' and b.FinalScore IN ($listnew) order by b.FinalScore desc");
											while($fetch_toppers2 = mysqli_fetch_array($topperQuery))
											{
										...
										$getCandidates = mysqli_query($dbconn,"select FinalScore from noc_course a, noc_testscores b where a.NOCCourseId=b.CourseId and a.NOCPeriod='".$period."' and b.CourseId='".$courseId."' order by FinalScore DESC limit $fivepercent");
										while($topperMarks = mysqli_fetch_assoc($getCandidates))
										{
											if($topperMarks['FinalScore'] >= 60)
											{
										...
										if(count($topperMarksArray) > 0)
										{
											echo "<br><div class='col-md-12 alert alert-success' style='text-align:center;font-weight:bold;font-size: 17px;'>Top 5 % of Certified Candidates</div>";
									...
									if(mysqli_num_rows($toppers_query) > 0)
									{
										...
										//	if($fetch_toppers['NOCPeriod']=='Jul-Sep 2016')
											?>
										    <div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
										      <img src="<?php if($fetch_toppers['NOCPeriod']=='Jan-Mar 2017'){echo '/noc/Candidate_photopath/'.$fetch_toppers['NOCPeriod']."/".$fetch_toppers['photopath'];} else {echo $fetch_toppers['photopath'];} ?>" alt="<?php echo $fetch_toppers['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
										      <div class="caption text-center">
										...
										{ ?>
										    <div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
										      	<img src="<?php if($fetch_toppers2['NOCPeriod']=='Jan-Mar 2017'){echo '/noc/Candidate_photopath/'.$fetch_toppers2['NOCPeriod']."/".$fetch_toppers2['photopath'];} else {echo $fetch_toppers2['photopath'];} ?>" alt="<?php echo $fetch_toppers2['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
										      	<div class="caption text-center">
													<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['Name']; ?> <span class="badge"><?php echo $fetch_toppers2['FinalScore'].'%'; ?></span></b></p>
												  	<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['CollegeName']; ?></b></p>
										          	<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['OrganizationName']; ?></b> </p>
