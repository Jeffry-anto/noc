...
<img src="<?php echo 'graph/'.$courseid1.'(A).jpg'; ?>" width="350px" height="250px"></a>
...
<img src="<?php echo 'graph/'.$courseid1.'(E).jpg'; ?>" width="350px" height="250px"></a>
<div id="examModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="<?php echo 'graph/'.$courseid1.'(E).jpg'; ?>" width="450px" height="350px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<img src="graph/<?php echo $courseid1.'(F).jpg'; ?>" width="350px" height="250px" ></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="<?php echo 'graph/'.$courseid1.'(F).jpg'; ?>" width="450px" height="350px">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
						...
						<div class="panel-heading text-center"><b><?php echo $fetch_nocperiod['NOCCourseName']; ?> - Toppers list</b></div>
				  		<div class="panel-body">
							<?php
								...
								elseif($examperiod == 'Mar 2017' || $examperiod == 'Apr 2017')
								{
									$month="Jan";
								}
