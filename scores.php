...
elseif($tl == 'Jan-Mar 2016' || $tl == 'Jan-Apr 2016')
{
?>

<h4><span class="glyphicon glyphicon-chevron-right"></span>&nbsp;&nbsp;<a href="./download_receipt_mar_2016.php?app=<?php echo $apnum;?>&course=<?= $fetch_course['NOCCourseName'] ?>">Download Payment Receipt</a></h4>
<?php
}
else { ?>
		<!-- <h4><span class="glyphicon glyphicon-chevron-right"></span>&nbsp;&nbsp; Sorry We Not able to generate the payment recipt.</h4> -->
<?php }
} else { ?>
