								...
								if($examperiod == 'Sep 2016' || $examperiod == 'Oct 2016')
								{
									...
									if($certified_candidates <= 10)
									{
										...
										if(count($topperMarksArray) >0)
										{
											...
											{ ?>
												<div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
													<img src="./Candidate_photopath/<?php echo "Jul-".$examperiod."/".$fetch_toppers2['photopath'];?>" alt="<?php echo $fetch_toppers2['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
													<div class="caption text-center">
										...
										if(count($topperMarksArray) >0)
										{
											...
											{ ?>
												<div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
													<img src="./Candidate_photopath/<?php echo "Jul-".$examperiod."/".$fetch_toppers2['photopath'];?>" alt="<?php echo $fetch_toppers2['Name']; ?>" alt="<?php echo $fetch_toppers2['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
													<div class="caption text-center">
														<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['Name']; ?> <span class="badge"><?php echo $fetch_toppers2['FinalScore'].'%'; ?></span></b></p>
														<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['CollegeName']; ?></b></p>
													    <p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['OrganizationName']; ?></b> </p>
									...
									if(mysqli_num_rows($toppers_query) > 0)
									{
										...
										{ 
											?>
										    <div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
										      <img src="<?php if($fetch_toppers['NOCPeriod']=='Jul-Sep 2016'){echo '/noc/Candidate_photopath/'.$fetch_toppers['NOCPeriod']."/".$fetch_toppers['photopath'];} else {echo $fetch_toppers['photopath'];} ?>" alt="<?php echo $fetch_toppers['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
										      <div class="caption text-center">
										...
										{ ?>
										    <div class="thumbnail" style="margin:5px; width:260px; height:180px; overflow: hidden; display:inline-block; font-size:14px;">
										      	<img src="<?php if($fetch_toppers2['NOCPeriod']=='Jul-Sep 2016'){echo '/noc/Candidate_photopath/'.$fetch_toppers2['NOCPeriod']."/".$fetch_toppers2['photopath'];} else {echo $fetch_toppers2['photopath'];} ?>" alt="<?php echo $fetch_toppers2['Name']; ?>" id="logo" class="img-circle" style="border:1px solid #666;">
										      	<div class="caption text-center">
													<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['Name']; ?> <span class="badge"><?php echo $fetch_toppers2['FinalScore'].'%'; ?></span></b></p>
												  	<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['CollegeName']; ?></b></p>
										          	<p style="font-size:11px; text-transform:uppercase"><b><?php echo $fetch_toppers2['OrganizationName']; ?></b> </p>
