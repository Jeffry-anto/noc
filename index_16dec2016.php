  ...
  <div class="item active">
    ...
    <div class="item">
     <img src="images/slider/slide_4.jpg" alt="slider 3" height="100">
      <div class="carousel-caption">
		  <h3><b>New set of courses will start in July 2016. Enrollment will open by mid May 2016.</b></h3>
      </div>
    </div>
  </div>
...
if(isset($_POST['submit']))
{
	...
	{
		$validate_query = mysqli_query($dbconn,"select EmailId from noc_testscores where EmailId='".$username."' and DOB='".$password."' ");
