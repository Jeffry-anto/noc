...
<body>
		<?php if(isset($_POST['apnum']) || isset($_GET['app'])) 
		{
			...
			$sql = "SELECT * FROM NOC_db.noc_testscores a,NOCPayment.noctransaction_table b where a.Application_number = b.ApplicationNumber and b.ApplicationNumber = '$appnum'";//
			...
			if(sizeof($row) > 0)
			{
				...
				$paydate = substr($row['paymentdate'],0,10);
				$pd = $row['paymentdate'];
			    ...
			    if(substr($appnum,0,5)=='STAPR')
			    {
			    $timeline='Jan-Apr 2016';
			    }
			    elseif(substr($appnum,0,5)=='STMAR')
			    {
			...
			<div class="list-groupp" styele="margin-top:10px;">
			  <!-- <div class="list-group-itemm"><b>Name : </b><?php echo $name;?></div><br>
				...
				<div class="receiptcontent">
					...
					<center><b>Receipt for successful payment of fees for online courses conducted by NPTEL<br>Course Run: <?= $timeline ?></b></center><br><br>
				...
				<div class="receiptcontent">
					...
					<center><b>Receipt for successful payment of fees for online courses conducted by NPTEL<br>Course Run: <?= $timeline ?></b></center><br><br>
					<div>&nbsp;&nbsp;Name of candidate :  <b><?php echo $name;?></b></div><br>
					<div>&nbsp;&nbsp;Course name : <b><?php echo $coursename;?></b></div><br>
