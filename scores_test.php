...
if($id != '')
{
	$query=mysqli_query($dbconn,"select * from noc_testscores where EmailId='".$user."' and CourseId='".$id."' ");
	...
	//echo $examperiod;
									...
									} else if($certified_candidates > 100)
									{
										...
										if(count($topperMarksArray) > 0)
										{
											if(in_array($fetch_scores['FinalScore'],$topperMarksArray))
											{ ?>
											  	<div class="alert alert-success text-center" role="alert"><a href="http://nptel.ac.in/noc/individual_course.php?id=<?php echo $id; ?>"><h5><b> <i class="glyphicon glyphicon-tag"></i>&nbsp;Congrats! You are in the top 1% in this course</b></h5></a></div>
												<?php
											}
										}
...
if(($fetch_course['NOCPeriod'] = 'Jan-Mar 2017' && $fetch_scores['Topper'] == '2') || ($fetch_course['NOCPeriod'] != 'Jan-Apr 2017' && $fetch_scores['Topper'] == '2'))
{
?>
<div class="alert alert-success text-center" role="alert"><a href="http://nptel.ac.in/noc/individual_course.php?id=<?php echo $id; ?>"><h5><b> <i class="glyphicon glyphicon-tag"></i>&nbsp;Congrats! You are in the top 2% in this course</b></h5></a></div>
 <?php
 }
 elseif(($fetch_course['NOCPeriod'] = 'Jan-Mar 2017' && $fetch_scores['Topper'] == '5') || ($fetch_course['NOCPeriod'] != 'Jan-Apr 2017' && $fetch_scores['Topper'] == '5'))
 {
?>
<div class="alert alert-success text-center" role="alert"><a href="http://nptel.ac.in/noc/individual_course.php?id=<?php echo $id; ?>"><h5><b> <i class="glyphicon glyphicon-tag"></i>&nbsp;Congrats! You are in the top 5% in this course</b></h5></a></div>
<?php
 }

		/*if($fetch_course['NOCPeriod'] != 'Jul-Sep 2016' && $fetch_course['NOCPeriod'] != 'Jul-Oct 2016' && $fetch_course['NOCPeriod'] != 'Sep-Oct 2016' && $fetch_course['NOCPeriod'] != 'Jan-Mar 2017' && $fetch_course['NOCPeriod'] != 'Jan-Apr 2017' && $fetch_course['NOCPeriod'] != 'Jan-Feb 2017' )
		{
			$arrynew = array();
...
if($fetch_course['NOCEnableDownloadCertificate'] == 'Y'){
	if($fetch_scores['CertificateEligible'] == 'Y'){
			if($fetch_scores['Timeline'] == 'Jan-Mar 2017'){
?>
<h4><span class="glyphicon glyphicon-chevron-right"></span>&nbsp;&nbsp;<a href="<?php echo 'E_Certificate/'.$fetch_scores['CourseId'].'/'.$fetch_scores['RollNumber'].'.pdf'; ?>" download>Download E-Certificate</a></h4>
<?php
		}
		   	else {
		?>
...
if(strlen($apnum) > 0)
{	
$examcourseid = substr($fetch_course['NOCCourseId'],0,-5);
echo $examcourseid;
	if($examcourseid =='noc16' || $examcourseid =='noc17')
	{   ?>

		<h4><span class="glyphicon glyphicon-chevron-right"></span>&nbsp;&nbsp;<a href="./download_receipt_test.php?app=<?php echo $apnum;?>&run=<?php echo $examcourseid;?>">Download Payment Receipt</a></h4>
<?php	}
...
<?php }
elseif($tl == 'Jan-Mar 2017' || $tl == 'Jan-Apr 2017' || $tl == 'Jan-Feb 2017')
{
	?>
	<h4><span class="glyphicon glyphicon-chevron-right"></span>&nbsp;&nbsp;<a href="./download_receipt_sep_2016.php?app=<?php echo $apnum;?>">Download Payment Receipt</a></h4>
	<?php
